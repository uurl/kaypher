...
package com.koneksys.kaypher.schema.kaypher;
...
public class LogicalSchemasTest {
  ...
  private static final BiMap<Type, Schema> SQL_TO_LOGICAL = ImmutableBiMap.<Type, Schema>builder()
      ...
      .put(com.koneksys.kaypher.parser.tree.Array.of(PrimitiveType.of(SqlType.INTEGER)),
          SchemaBuilder.array(LogicalSchemas.INTEGER).optional().build())
      .put(com.koneksys.kaypher.parser.tree.Map.of(PrimitiveType.of(SqlType.INTEGER)),
          SchemaBuilder.map(LogicalSchemas.STRING, LogicalSchemas.INTEGER).optional().build())
      .put(com.koneksys.kaypher.parser.tree.Struct.builder()
  ...
  private static final Type STRUCT_SQL_TYPE = com.koneksys.kaypher.parser.tree.Struct.builder()
      .addField("F0", PrimitiveType.of(SqlType.INTEGER))
      .build();

  private static final Type NESTED_SQL_TYPE = com.koneksys.kaypher.parser.tree.Struct.builder()
      .addField("ARRAY", com.koneksys.kaypher.parser.tree.Array.of(STRUCT_SQL_TYPE))
      .addField("MAP", com.koneksys.kaypher.parser.tree.Map.of(STRUCT_SQL_TYPE))
