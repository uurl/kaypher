  ...
  public void shouldImplementHashCodeAndEqualsProperty() {
    new EqualsTester()
        .addEqualityGroup(
            ...
            new WhenClause(EXP_0, EXP_1),
            new WhenClause(EXP_0, EXP_1),
            new WhenClause(Optional.of(SOME_LOCATION), EXP_0, EXP_1),
            new WhenClause(Optional.of(OTHER_LOCATION), EXP_0, EXP_1)
        )
        .addEqualityGroup(
            new WhenClause(DIFF, EXP_1)
        )
        .addEqualityGroup(
            new WhenClause(EXP_0, DIFF)
        )
        .testEquals();
  }
}