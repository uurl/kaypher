...
import com.koneksys.kaypher.parser.AstBuilder;
import com.koneksys.kaypher.parser.SqlBaseBaseVisitor;
import com.koneksys.kaypher.parser.SqlBaseParser;
  ...
  private final class Visitor extends SqlBaseBaseVisitor<Node> {
    ...
    public Node visitAliasedRelation(final SqlBaseParser.AliasedRelationContext context) {
      ...
      if (!isJoin) {
        ...
        if (fromDataSource == null) {
          throw new KaypherException(table.getName().getSuffix() + " does not exist.");
        }
    ...
    public Node visitJoinRelation(final SqlBaseParser.JoinRelationContext context) {
      ...
      if (leftDataSource == null) {
        throw new KaypherException(((Table) left.getRelation()).getName().getSuffix() + " does not "
            + "exist.");
      }
      ...
      if (rightDataSource == null) {
        throw new KaypherException(((Table) right.getRelation()).getName().getSuffix() + " does not "
            + "exist.");
      }
