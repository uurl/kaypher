...
public class StaticQueryValidator implements QueryValidator {
  ...
  private static final String NEW_QUERY_SYNTAX_HELP = " "
      ...
      + System.lineSeparator()
      + "Query syntax in KAYPHER has changed. There are now two broad categories of queries:"
      + System.lineSeparator()
      ...
      + "versions of KAYPHER, add `EMIT CHANGES` to the end of the statement before any LIMIT clause."
      + System.lineSeparator()
      + System.lineSeparator()
  ...
  public void validate(final Analysis analysis) {
    try {
      ...
      throw new KaypherException(e.getMessage() + NEW_QUERY_SYNTAX_HELP, e);
    }
  }
  ...
  private static final class Rule {
    ...
    public void check(final Analysis analysis) {
      if (!condition.test(analysis)) {
        throw new KaypherException(failureMsg);
      }
    }
  }
}
