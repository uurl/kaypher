...
/**
 * Interface that provides authorization to KAYPHER.
 */
public interface KaypherAuthorizationProvider {
  /**
   ...
   * @param path The endpoint path to access, i.e. "/kaypher", "/kaypher/terminate", "/query"*
   */
