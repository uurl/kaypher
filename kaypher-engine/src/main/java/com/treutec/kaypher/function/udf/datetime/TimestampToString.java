...
@UdfDescription(name = "timestamptostring", author = KaypherConstants.CONFLUENT_AUTHOR,
...
public class TimestampToString {
  ...
  public String timestampToString(
    ...
    try {
      ...
      throw new KaypherFunctionException("Failed to format timestamp " + epochMilli
