...
@UdfDescription(name = "substring",
    ...
    description = "Returns a substring of the passed in value.\n"
        ...
        + "\t" + KaypherConfig.KAYPHER_FUNCTIONS_SUBSTRING_LEGACY_ARGS_CONFIG + "\n"
...
public class Substring implements Configurable {
  ...
  public void configure(final Map<String, ?> props) {
    final KaypherConfig config = new KaypherConfig(props);
    final boolean legacyArgs =
        config.getBoolean(KaypherConfig.KAYPHER_FUNCTIONS_SUBSTRING_LEGACY_ARGS_CONFIG);
