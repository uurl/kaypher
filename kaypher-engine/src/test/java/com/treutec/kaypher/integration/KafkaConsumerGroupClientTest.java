...
import com.treutec.kaypher.test.util.ConsumerGroupTestUtil;
import com.treutec.kaypher.test.util.TopicTestUtil;
import com.treutec.kaypher.util.KafkaConsumerGroupClient;
import com.treutec.kaypher.util.KafkaConsumerGroupClient.ConsumerSummary;
import com.treutec.kaypher.util.KafkaConsumerGroupClientImpl;
...
public class KafkaConsumerGroupClientTest {
  ...
  @Before
  public void startUp() {
    final KaypherConfig kaypherConfig = KaypherConfigTestUtil.create(TEST_HARNESS.getKafkaCluster());

    adminClient = AdminClient.create(kaypherConfig.getKaypherAdminClientConfigProps());
