...
import com.treutec.kaypher.exception.KafkaTopicExistsException;
...
public class KafkaTopicClientImplTest {
  ...
  private static final String internalTopic1 = String.format("%s%s_%s",
      KaypherConstants.KAYPHER_INTERNAL_TOPIC_PREFIX,
      "default",
  ...
  private static final String confluentInternalTopic =
      String.format("%s-%s", KaypherConstants.CONFLUENT_INTERNAL_TOPIC_PREFIX,
