...
import com.treutec.kaypher.engine.rewrite.StatementRewriter.Context;
...
import com.treutec.kaypher.parser.tree.Join.Type;
...
public class StatementRewriterTest {
  ...
  public void shouldRewriteWindowExpression() {
    // Given:
    final KaypherWindowExpression kaypherWindowExpression = mock(KaypherWindowExpression.class);
    final WindowExpression windowExpression =
        new WindowExpression(location, "name", kaypherWindowExpression);
    ...
    assertThat(
        rewritten,
        equalTo(new WindowExpression(location, "name", kaypherWindowExpression))
    );
  }
