...
public class UdfClassLoaderTest {
  ...
  private static final String ONLY_IN_JAR = "org.damian.kaypher.udf.ToString";
  private static final String ONLY_IN_PARENT = "class.that.exists.only.in.parent";
  private static final String IN_PARENT_AND_JAR = "org.damian.kaypher.udf.ToStruct";

  // The jar contains the class org.damian.kaypher.udf.ToString and org.damian.kaypher.udf.ToStruct.
