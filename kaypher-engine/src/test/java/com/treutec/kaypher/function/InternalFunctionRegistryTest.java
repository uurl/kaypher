...
public class InternalFunctionRegistryTest {
  ...
  private final KaypherScalarFunction func = KaypherScalarFunction.createLegacyBuiltIn(
  ...
  @Mock
  private KaypherTableFunction tableFunction;
  ...
  public void shouldNotAddFunctionWithSameNameAsExistingFunctionAndOnDifferentClass() {
    ...
    final KaypherScalarFunction func2 = KaypherScalarFunction.createLegacyBuiltIn(
        Schema.OPTIONAL_STRING_SCHEMA,
        Collections.emptyList(),
  ...
  private static AggregateFunctionFactory createAggregateFunctionFactory() {
    return new AggregateFunctionFactory("my_aggregate") {
      @Override
      public KaypherAggregateFunction createAggregateFunction(final List<Schema> argTypeList,
          final AggregateFunctionInitArguments initArgs) {
        return new KaypherAggregateFunction() {
  ...
  private TableFunctionFactory createTableFunctionFactory() {
    return new TableFunctionFactory(new UdfMetadata("my_tablefunction",
        "", "", "", "", false)) {
      @Override
      public KaypherTableFunction createTableFunction(List<Schema> argTypeList) {
