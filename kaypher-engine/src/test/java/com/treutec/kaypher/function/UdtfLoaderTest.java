...
public class UdtfLoaderTest {
  ...
  public void shouldLoadSimpleParams() {
    ...
    // When:
    final KaypherTableFunction function = FUNC_REG.getTableFunction("test_udtf", args);
  ...
  public void shouldNotLoadUdtfWithWrongReturnValue() {
    ...
    expectedException
        .expectMessage(
            is("UDTF functions must return a List. Class com.treutec.kaypher.function.UdtfLoaderTest$UdtfBadReturnValue Method badReturn"));

    // When:
    udtfLoader.loadUdtfFromClass(UdtfBadReturnValue.class, KaypherScalarFunction.INTERNAL_PATH);
  }
  ...
  public void shouldNotLoadUdtfWithRawListReturn() {
    ...
    expectedException
        .expectMessage(
            is("UDTF functions must return a parameterized List. Class com.treutec.kaypher.function.UdtfLoaderTest$RawListReturn Method badReturn"));

    // When:
    udtfLoader.loadUdtfFromClass(RawListReturn.class, KaypherScalarFunction.INTERNAL_PATH);
  }
  ...
  public void shouldNotLoadUdtfWithBigDecimalReturnAndNoSchemaProvider() {
    ...
    // When:
    udtfLoader
        .loadUdtfFromClass(BigDecimalNoSchemaProvider.class, KaypherScalarFunction.INTERNAL_PATH);
  }
