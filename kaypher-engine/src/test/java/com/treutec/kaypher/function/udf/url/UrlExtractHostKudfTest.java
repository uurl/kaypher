...
public class UrlExtractHostKudfTest {
  ...
  public void shouldExtractHostIfPresent() {
    assertThat(extractUdf.extractHost("https://docs.confluent.io:8080/current/kaypher/docs/syntax-reference.html#scalar-functions"), equalTo("docs.confluent.io"));
  }

  @Test
  public void shouldReturnNullIfNoHost() {
    assertThat(extractUdf.extractHost("https:///current/kaypher/docs/syntax-reference.html#scalar-functions"), nullValue());
  }
