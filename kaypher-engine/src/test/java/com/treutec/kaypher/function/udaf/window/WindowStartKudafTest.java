...
public class WindowStartKudafTest {

  @Test
  public void shouldReturnCorrectFunctionName() {
    assertThat(WindowStartKudaf.getFunctionName(),
        is(WindowStartKudaf.class.getAnnotation(UdafDescription.class).name()));
  }

  @Test
  public void shouldCreatePlaceholderTableUdaf() {
    assertThat(WindowStartKudaf.createWindowStart(), is(instanceOf(PlaceholderTableUdaf.class)));
  }
}