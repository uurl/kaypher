...
import static com.treutec.kaypher.serde.Format.KAFKA;
import static com.treutec.kaypher.util.SchemaUtil.ROWKEY_NAME;
...
import com.treutec.kaypher.ddl.commands.CreateSourceFactory.SerdeOptionsSupplier;
...
public class CreateSourceFactoryTest {
  ...
  public void shouldCreateCommandForCreateStream() {
    ...
    final DdlCommand result = createSourceFactory
        .createStreamCommand(sqlExpression, ddlStatement, kaypherConfig);
  ...
  public void shouldCreateCommandForCreateTable() {
    ...
    // When:
    final DdlCommand result = createSourceFactory
        .createTableCommand(sqlExpression, ddlStatement, kaypherConfig);
  ...
  public void shouldCreateStreamCommandWithSingleValueWrappingFromConfig() {
    ...
    // When:
    final DdlCommand cmd = createSourceFactory
        .createStreamCommand(sqlExpression, statement, kaypherConfig);
  ...
  public void shouldCreateTableCommandWithSingleValueWrappingFromConfig() {
    ...
    // When:
    final DdlCommand cmd = createSourceFactory
        .createTableCommand(sqlExpression, statement, kaypherConfig);
  ...
  public void shouldThrowOnNoElementsInCreateStream() {
    ...
    // When:
    createSourceFactory.createStreamCommand("expression", statement, kaypherConfig);
  }
  ...
  public void shouldThrowOnNoElementsInCreateTable() {
    ...
    // When:
    createSourceFactory.createTableCommand("expression", statement, kaypherConfig);
  }
  ...
  public void shouldThrowOnRowTimeValueColumn() {
    ...
    // When:
    createSourceFactory.createStreamCommand("sqlExpression", statement, kaypherConfig);
  }
  ...
  public void shouldThrowOnRowKeyIfNotString() {
    ...
    expectedException.expectMessage("'ROWKEY' is a KEY column with an unsupported type. "
        + "KAYPHER currently only supports KEY columns of type STRING.");
