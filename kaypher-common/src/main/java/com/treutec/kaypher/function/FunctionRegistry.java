...
public interface FunctionRegistry {
   ...
   * @return the factory.
   * @throws KaypherException on unknown UDF.
   */
   ...
   * @param functionName the name of the function
   * @return the factory.
   * @throws KaypherException on unknown UDAF.
   */
   ...
   * @throws KaypherException on unknown UDAF, or on unsupported {@code argumentType}.
   */
  KaypherAggregateFunction<?, ?> getAggregate(String functionName, Schema argumentType);
