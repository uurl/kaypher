...
public interface ConfigResolver {
   ...
   * {@link com.treutec.kaypher.util.KaypherConfig#KAYPHER_FUNCTIONS_PROPERTY_PREFIX}, will be resolved.
   * All others will result in {@code empty}.
   *
   * <p>For non-{@code strict} resolution, only configuration <i>known</i> to be invalid, e.g.
   * properties that are prefixed with {@code kaypher.}, but which are not known KAYPHER config, will
