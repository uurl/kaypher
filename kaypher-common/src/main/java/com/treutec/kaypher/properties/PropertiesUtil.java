...
public final class PropertiesUtil {
  ...
  private static Map<String, String> loadPropsFromFile(final File propertiesFile) {
    ...
    try (FileInputStream inputStream = new FileInputStream(propertiesFile)) {
      ...
      throw new KaypherException("Failed to load properties file: " + propertiesFile);
    }
  ...
  private static void throwOnBlackListedProperties(final Map<String, ?> properties) {
    ...
    if (!blacklisted.isEmpty()) {
      throw new KaypherException("Property file contains the following blacklisted properties "
