...
import com.treutec.kaypher.configdef.ConfigValidators;
    ...
    configDef
        ...
        .define(
            ...
            "The name of a field within the Kafka record value that contains the "
                + "timestamp KAYPHER should use inplace of the default Kafka record timestamp. "
                + "By default, KAYPHER requires the timestamp to be a `BIGINT`. Alternatively, you "
        ...
        .define(
            ...
            "Controls how values are deserialized where the value schema contains "
                + "only a single field.  If set to true, KAYPHER expects the field to have been "
                + "serialized as a named field within a record. If set to false, KAYPHER expects the "
