...
import static com.treutec.kaypher.configdef.ConfigValidators.enumValues;
  ...
  private static final ConfigDef CONFIG_DEF = new ConfigDef()
      .define(
          ...
          "The name of a field within the Kafka record value that matches the key. "
              + "This may be used by KAYPHER to avoid unnecessary repartitions."
      ).define(
          ...
          Importance.LOW,
          "If the data is windowed, i.e. was created using KAYPHER using a query that "
          ...
          Importance.LOW,
          "If the data is windowed, i.e., was created using KAYPHER via a query that "
