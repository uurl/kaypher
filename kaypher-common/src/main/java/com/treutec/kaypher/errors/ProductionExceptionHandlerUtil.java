...
public final class ProductionExceptionHandlerUtil {
  public static final String KAYPHER_PRODUCTION_ERROR_LOGGER = "kaypher.logger.production.error";
  ...
  abstract static class LogAndXProductionExceptionHandler implements ProductionExceptionHandler {
    ...
    public void configure(final Map<String, ?> configs) {
      final Object logger = configs.get(KAYPHER_PRODUCTION_ERROR_LOGGER);
