...
public class ProcessingLogConfig extends AbstractConfig {
  ...
  private static String propertyName(final String name) {
    return KaypherConfig.KAYPHER_CONFIG_PROPERTY_PREFIX + PROPERTY_PREFIX + name;
  }

  public static final String STREAM_NAME = propertyName("stream.name");
  private static final String STREAM_NAME_DEFAULT = "KAYPHER_PROCESSING_LOG";
  private static final String STREAM_NAME_DOC =
      "If automatic processing log stream creation is enabled, KAYPHER sets the name of the "
  ...
  public static final String TOPIC_NAME_DEFAULT_SUFFIX = "kaypher_processing_log";
  private static final String TOPIC_NAME_DOC =
      "If automatic processing log topic creation is enabled, KAYPHER sets the name of the "
          + "topic to the value of this property. If automatic processing log stream "
          + "creation is enabled, KAYPHER uses this topic to back the stream.";
  ...
  private static final String TOPIC_PARTITIONS_DOC =
      "If automatic processing log topic creation is enabled, KAYPHER creates the topic with "
  ...
  private static final String STREAM_AUTO_CREATE_DOC = String.format(
      "Toggles automatic processing log stream creation. If set to true, and "
          + "running interactive mode on a new cluster, then KAYPHER will automatically "
  ...
  private static final String TOPIC_AUTO_CREATE_DOC = String.format(
      "Toggles automatic processing log topic creation. If set to true, then "
          + "KAYPHER will automatically try to create a processing log topic at startup. "
