...
import com.treutec.kaypher.schema.connect.SchemaFormatter;
 ...
 * kaypher-functional-tests module to ensure the schemas of data persisted to topics doesn't change
 * between releases.
 */
@Immutable
