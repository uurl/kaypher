...
import com.treutec.common.utils.Time;
 ...
 * streams/tables/queries for kaypher entities (Stream, Table, Query)
 */
public final class MetricCollectors {
  ...
  private static final Time time = new com.treutec.common.utils.SystemTime();
  ...
  // others metric data. We also need it from the KaypherEngineMetricsTest
  public static void initialize() {
    ...
    reporters.add(new JmxReporter("com.treutec.kaypher.metrics"));
    ...
    // a full, fresh instantiation here ensures something like KaypherEngineMetricsTest running after
  ...
  // clobber each other. We also need to call it from the KaypherEngineMetrics test for the same
  // reason.
