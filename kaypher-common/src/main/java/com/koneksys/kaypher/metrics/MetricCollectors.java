...
import com.koneksys.common.utils.Time;
...
public final class MetricCollectors {
  ...
  private static final Time time = new com.koneksys.common.utils.SystemTime();
  ...
  public static void initialize() {
    ...
    reporters.add(new JmxReporter("com.koneksys.kaypher.metrics"));
