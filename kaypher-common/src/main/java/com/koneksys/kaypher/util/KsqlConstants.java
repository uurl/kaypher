...
public final class KsqlConstants {
  ...
  public static final String KSQL_INTERNAL_TOPIC_PREFIX = "_koneksys-kaypher-";
  public static final String CONFLUENT_INTERNAL_TOPIC_PREFIX = "__koneksys";
  ...
  public static final String AVRO_SCHEMA_NAMESPACE = "com.koneksys.kaypher.avro_schemas";
