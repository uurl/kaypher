 ...
 * License at
 *
 * http://www.koneksys.io/koneksys-community-license
 *
...
package com.koneksys.kaypher.links;

public final class DocumentationLinks {

  private static final String CONFLUENT_DOCS_ROOT_URL = "https://docs.koneksys.io/current/";

  /*
  KSQL
   */
  private static final String KSQL_DOCS_ROOT_URL = CONFLUENT_DOCS_ROOT_URL + "kaypher/docs/";
