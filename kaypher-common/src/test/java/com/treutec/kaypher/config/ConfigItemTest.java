...
public class ConfigItemTest {
  ...
  private static final ConfigKey KEY_NO_VALIDATOR = KaypherConfig.CURRENT_DEF.configKeys()
      .get(KaypherConfig.KAYPHER_SERVICE_ID_CONFIG);
  ...
  private static final ConfigKey PASSWORD_KEY = KaypherConfig.CURRENT_DEF.configKeys()
  ...
  public void shouldReturnPropertyName() {
    assertThat(RESOLVED_NO_VALIDATOR.getPropertyName(),
        is(KaypherConfig.KAYPHER_SERVICE_ID_CONFIG));
  ...
  public void shouldParseResolvedValue() {
    assertThat(RESOLVED_NO_VALIDATOR.parseValue("kaypher_default"), is("kaypher_default"));
  }
