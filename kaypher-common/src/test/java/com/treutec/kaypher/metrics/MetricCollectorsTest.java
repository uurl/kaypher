...
public class MetricCollectorsTest {
  ...
  private KaypherConfig kaypherConfig = mock(KaypherConfig.class);
  ...
  public void shouldAddConfigurableReporters() {
    ...
    when(kaypherConfig.getConfiguredInstances(any(), any()))
        .thenReturn(Collections.singletonList(mockReporter));

    MetricCollectors.addConfigurableReporter(kaypherConfig);
