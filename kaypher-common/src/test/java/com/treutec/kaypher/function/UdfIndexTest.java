...
import static com.treutec.kaypher.function.KaypherScalarFunction.INTERNAL_PATH;
...
public class UdfIndexTest {
  ...
  private UdfIndex<KaypherScalarFunction> udfIndex;

  @Before
  public void setUp() {
    udfIndex = new UdfIndex<KaypherScalarFunction>("name");
  }
  ...
  public void shouldFindNoArgs() {
    // Given:
    final KaypherScalarFunction[] functions = new KaypherScalarFunction[]{function(EXPECTED, false)};
    Arrays.stream(functions).forEach(udfIndex::addFunction);

    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of());
  ...
  public void shouldFindOneArg() {
    // Given:
    final KaypherScalarFunction[] functions = new KaypherScalarFunction[]{
        function(EXPECTED, false, STRING)};
    Arrays.stream(functions).forEach(udfIndex::addFunction);

    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRING));
  ...
  public void shouldFindTwoDifferentArgs() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRING, INT));
  ...
  public void shouldFindTwoSameArgs() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRING, STRING));
  ...
  public void shouldChooseCorrectStruct() {
    // Given:
    final KaypherScalarFunction[] functions = new KaypherScalarFunction[]{function(OTHER, false, STRUCT2),
        function(EXPECTED, false, STRUCT1)};
    Arrays.stream(functions).forEach(udfIndex::addFunction);

    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRUCT1));
  ...
  public void shouldChooseCorrectMap() {
    // Given:
    final KaypherScalarFunction[] functions = new KaypherScalarFunction[]{function(OTHER, false, MAP2),
        function(EXPECTED, false, MAP1)};
    Arrays.stream(functions).forEach(udfIndex::addFunction);

    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(MAP1));
  ...
  public void shouldChooseCorrectDecimal() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(DECIMAL1));
  ...
  public void shouldAllowAnyDecimal() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(DECIMAL2));
  ...
  public void shouldChooseCorrectPermutedStruct() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRUCT3));
  ...
  public void shouldFindVarargWithStruct() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRUCT1, STRUCT1));
  ...
  public void shouldFindVarargWithList() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(STRING_VARARGS));
  ...
  public void shouldChooseVarArgsIfSpecificDoesntMatch() {
    // Given:
    final KaypherScalarFunction[] functions = new KaypherScalarFunction[]{function(OTHER, false, STRING),
        function(EXPECTED, true, STRING_VARARGS)};
    Arrays.stream(functions).forEach(udfIndex::addFunction);
  ...
  public void shouldFindNonVarargWithNullValues() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Collections.singletonList(null));
  ...
  public void shouldFindNonVarargWithPartialNullValues() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(null, STRING));
  ...
  public void shouldFindVarargWithNullValues() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(new Schema[]{null}));
  ...
  public void shouldFindVarargWithSomeNullValues() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(null, STRING, null));
  ...
  public void shouldChooseNonVarargWithNullValuesOfDifferingSchemas() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(new Schema[]{null, null}));
  ...
  public void shouldChooseNonVarargWithNullValuesOfPartialNulls() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(STRING, null));
  ...
  public void shouldChooseCorrectlyInComplicatedTopology() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Arrays.asList(STRING, INT, null, INT));
  ...
  public void shouldFindGenericMethodWithIntParam() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Collections.singletonList(INT_LIST));
  ...
  public void shouldFindGenericMethodWithStringParam() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(Collections.singletonList(STRING_LIST));
  ...
  public void shouldMatchGenericMethodWithMultipleIdenticalGenerics() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(INT, INT));
  ...
  public void shouldMatchGenericMethodWithMultipleGenerics() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(INT, STRING));
  ...
  public void shouldMatchNestedGenericMethodWithMultipleGenerics() {
    ...
    // When:
    final KaypherScalarFunction fun = udfIndex.getFunction(ImmutableList.of(INT_LIST, INT_LIST));
  ...
  private static KaypherScalarFunction function(
      final String name,
