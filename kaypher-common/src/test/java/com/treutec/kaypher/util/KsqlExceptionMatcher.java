...
public final class KaypherExceptionMatcher {
  private KaypherExceptionMatcher() {
  }

  public static Matcher<?  super KaypherStatementException> statementText(
      final Matcher<String> statementMatcher
  ) {
    return new TypeSafeDiagnosingMatcher<KaypherStatementException>() {
      @Override
      protected boolean matchesSafely(
          final KaypherStatementException actual,
  ...
  public static Matcher<?  super KaypherStatementException> rawMessage(
