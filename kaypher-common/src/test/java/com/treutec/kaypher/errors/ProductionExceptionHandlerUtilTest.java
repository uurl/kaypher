...
package com.treutec.kaypher.errors;
...
import com.treutec.kaypher.errors.ProductionExceptionHandlerUtil.LogAndXProductionExceptionHandler;
import com.treutec.kaypher.logging.processing.ProcessingLogConfig;
import com.treutec.kaypher.logging.processing.ProcessingLogMessageSchema;
import com.treutec.kaypher.logging.processing.ProcessingLogMessageSchema.MessageType;
...
public class ProductionExceptionHandlerUtilTest {
  ...
  public void setUp() {
    CONFIGS = ImmutableMap.of(
        ProductionExceptionHandlerUtil.KAYPHER_PRODUCTION_ERROR_LOGGER, logger);
