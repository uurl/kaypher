...
package com.koneksys.kaypher.config;

import static org.hamcrest.CoreMatchers.is;
import static org.hamcrest.MatcherAssert.assertThat;

import com.koneksys.kaypher.config.ConfigItem.Resolved;
import com.koneksys.kaypher.util.KsqlConfig;
...
public class KsqlConfigResolverTest {
  ...
  private com.koneksys.kaypher.config.KsqlConfigResolver resolver;
  ...
  public void shouldReturnUnresolvedForOtherConfigIfNotStrict() {
    assertThat(resolver.resolve("koneksys.monitoring.interceptor.topic", false),
        is(unresolvedItem("koneksys.monitoring.interceptor.topic")));
  }

  @Test
  public void shouldReturnEmptyForOtherConfigIfStrict() {
    assertThat(resolver.resolve("koneksys.monitoring.interceptor.topic", true),
        is(Optional.empty()));
  }
