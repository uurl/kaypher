...
public class SchemaUtilTest {
  ...
  public void shouldCreateCorrectAvroSchemaWithNullableFields() {
    ...
    assertThat(avroSchemaString, equalTo(
        "{\"type\":\"record\",\"name\":\"orders\",\"namespace\":\"kaypher\",\"fields\":"
  ...
  public void shouldSupportAvroNestedStructs() {
    ...
    final String s0Schema = "{"
        + "\"type\":\"record\","
        + "\"name\":\"s0\","
        + "\"namespace\":\"kaypher.bob.NESTED_STRUCTS\","
        + "\"fields\":["
        + "{\"name\":\"f0\",\"type\":[\"null\",\"long\"],\"default\":null},"
        + "{\"name\":\"f1\",\"type\":[\"null\",\"boolean\"],\"default\":null}"
        + "]}";
    ...
    final String ss0Schema = "{"
        + "\"type\":\"record\","
        + "\"name\":\"ss0\","
        + "\"namespace\":\"kaypher.bob.NESTED_STRUCTS.s1\","
        + "\"fields\":["
        + "{\"name\":\"f0\",\"type\":[\"null\",\"long\"],\"default\":null},"
        + "{\"name\":\"f1\",\"type\":[\"null\",\"boolean\"],\"default\":null}"
        + "]}";
  ...
  public void shouldFailForCorrectJavaType() {
    ...
    try {
      ...
      Assert.fail();
    } catch (final KsqlException kaypherException) {
      assertThat("Invalid type retured.", kaypherException.getMessage(), equalTo("Type is not "
          + "supported: BYTES"));
    }
  }
