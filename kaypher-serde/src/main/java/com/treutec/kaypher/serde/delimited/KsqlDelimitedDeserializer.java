...
public class KaypherDelimitedDeserializer implements Deserializer<Object> {
  ...
  public KaypherDelimitedDeserializer(
  ...
  public Struct deserialize(final String topic, final byte[] bytes) {
    ...
    try {
      ...
      if (csvRecords.isEmpty()) {
        throw new KaypherException("No fields in record");
      }
  ...
  private static Object enforceFieldType(
    ...
    if (parser == null) {
      throw new KaypherException("Type is not supported: " + fieldSchema.type());
    }
