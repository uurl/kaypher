...
/**
 * Translates KAYPHER data and schemas to Avro equivalents.
 *
 * <p>Responsible for converting the KAYPHER schema to a version ready for connect to convert to an
 * avro schema.
 *
...
public class AvroDataTranslator implements DataTranslator {
  ...
  @Override
  public Object toKaypherRow(final Schema connectSchema, final Object connectObject) {
    final Object avroCompatibleRow = innerTranslator.toKaypherRow(connectSchema, connectObject);
