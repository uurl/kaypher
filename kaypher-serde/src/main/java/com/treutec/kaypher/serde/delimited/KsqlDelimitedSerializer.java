...
public class KaypherDelimitedSerializer implements Serializer<Object> {

  private final CSVFormat csvFormat;

  public KaypherDelimitedSerializer(final CSVFormat csvFormat) {
  ...
  private static class FieldIterator implements Iterator<Object> {
    ...
    private static void throwOnUnsupportedType(final Schema schema) {
      switch (schema.type()) {
        ...
        case MAP:
        case STRUCT:
          throw new KaypherException("DELIMITED does not support type: " + schema.type());
