...
public class KaypherDelimitedDeserializerTest {
  ...
  private KaypherDelimitedDeserializer deserializer;

  @Before
  public void setUp() {
    deserializer = new KaypherDelimitedDeserializer(ORDER_SCHEMA, CSVFormat.DEFAULT);
  }
  ...
  public void shouldThrowIfTopLevelNotStruct() {
    ...
    // When:
    new KaypherDelimitedDeserializer(schema, CSVFormat.DEFAULT.withDelimiter(','));
  }
  ...
  public void shouldDeserializedTopLevelPrimitiveTypeIfSchemaHasOnlySingleField() {
    ...
    final KaypherDelimitedDeserializer deserializer =
  ...
  private void shouldDeserializeDelimitedCorrectlyWithNonDefaultDelimiter(char delimiter) {
    ...
    final KaypherDelimitedDeserializer deserializer =
      new KaypherDelimitedDeserializer(ORDER_SCHEMA, CSVFormat.DEFAULT.withDelimiter('\t'));
  ...
  public void shouldThrowOnDeserializedTopLevelPrimitiveWhenSchemaHasMoreThanOneField() {
    ...
    // Then:
    expectedException.expect(SerializationException.class);
    expectedException.expectCause(instanceOf(KaypherException.class));
  ...
  private static KaypherDelimitedDeserializer createDeserializer(PersistenceSchema schema) {
    return new KaypherDelimitedDeserializer(schema, CSVFormat.DEFAULT.withDelimiter(','));
  }
