...
public class KaypherAvroSerializerTest {
  ...
  private KaypherConfig ksqlConfig = new KaypherConfig(ImmutableMap.of());
  ...
  public void shouldHandleNestedStruct() {
    ...
    final org.apache.avro.Schema nestedSchema = rename(ORDER_AVRO_SCHEMA,
        "KaypherDataSourceSchema_nested");
  ...
  public void shouldThrowOnMapSchemaWithNonStringKeys() {
    ...
    // When:
    new KaypherAvroSerdeFactory(KaypherConstants.DEFAULT_AVRO_SCHEMA_FULL_NAME)
        .createSerde(
            physicalSchema,
            ksqlConfig,
  ...
  public void shouldSerializeMapOfMaps() {
    ...
    final GenericArray<?> expected = buildConnectMapEntries(
        ...
        AvroTestUtil.connectOptionalKeyMapSchema(
            AvroTestUtil.connectOptionalKeyMapEntrySchema("KaypherDataSourceSchema_MapValue",
            org.apache.avro.Schema.create(Type.INT)))
    );
  ...
  public void shouldSerializeMapOfStruct() {
    ...
    final org.apache.avro.Schema elementSchema =
        rename(ORDER_AVRO_SCHEMA, "KaypherDataSourceSchema_MapValue");
  ...
  public void shouldSerializeMapFieldWithName() {
    final org.apache.avro.Schema avroSchema =
        AvroTestUtil.connectOptionalKeyMapSchema(
        connectMapEntrySchema(KaypherConstants.AVRO_SCHEMA_NAMESPACE + ".KaypherDataSourceSchema_field0"));
  ...
  public void shouldSerializeMapFieldWithoutNameIfDisabled() {
    ksqlConfig = new KaypherConfig(ImmutableMap.of(
        KaypherConfig.KAYPHER_USE_NAMED_AVRO_MAPS, false
    ));
  ...
  public void shouldSerializeMultipleMapFields() {
    final org.apache.avro.Schema avroInnerSchema0
        ...
        KaypherConstants.AVRO_SCHEMA_NAMESPACE + ".KaypherDataSourceSchema_field0_inner0");
    final org.apache.avro.Schema avroInnerSchema1 =
        AvroTestUtil.connectOptionalKeyMapEntrySchema(
            KaypherConstants.AVRO_SCHEMA_NAMESPACE + ".KaypherDataSourceSchema_field0_inner1",
            org.apache.avro.Schema.create(Type.STRING));
    final org.apache.avro.Schema avroSchema =
        org.apache.avro.SchemaBuilder.record("KaypherDataSourceSchema_field0")
            .namespace("io.confluent.ksql.avro_schemas")
            .fields()
  ...
  public void shouldSerializeStructField() {
    final org.apache.avro.Schema avroSchema
        = org.apache.avro.SchemaBuilder.record(KaypherConstants.AVRO_SCHEMA_NAME + "_field0")
        .namespace(KaypherConstants.AVRO_SCHEMA_NAMESPACE)
        .fields()
        .name("field1")
  ...
  public void shouldUseSchemaNameFromPropertyIfExists() {
    ...
    final Serializer<Object> serializer =
        new KaypherAvroSerdeFactory(schemaNamespace + "." + schemaName)
            .createSerde(
  ...
  private static org.apache.avro.Schema recordSchema(
    ...
    final FieldAssembler<org.apache.avro.Schema> builder = org.apache.avro.SchemaBuilder
        ...
        .record("KaypherDataSourceSchema")
        .fields();
  ...
  private void shouldSerializeFieldTypeCorrectly(final Schema ksqlSchema,
    ...
    // Then:
    final GenericRecord avroRecord = deserialize(bytes);
    assertThat(avroRecord.getSchema().getNamespace(), equalTo(KaypherConstants.AVRO_SCHEMA_NAMESPACE));
    assertThat(avroRecord.getSchema().getName(), equalTo(KaypherConstants.AVRO_SCHEMA_NAME));
  ...
  private void givenSerializerForSchema(final Schema schema) {
    ...
    serializer = new KaypherAvroSerdeFactory(KaypherConstants.DEFAULT_AVRO_SCHEMA_FULL_NAME)
        .createSerde(
  ...
  private org.apache.avro.Schema avroSchemaStoredInSchemaRegistry() {
    try {
      final SchemaMetadata schemaMetadata = schemaRegistryClient
          .getLatestSchemaMetadata(SOME_TOPIC + KaypherConstants.SCHEMA_REGISTRY_VALUE_SUFFIX);
  ...
  private static GenericArray<GenericRecord> buildConnectMapEntries(
    ...
    final org.apache.avro.Schema entrySchema =
        AvroTestUtil.connectOptionalKeyMapEntrySchema("KaypherDataSourceSchema", valueSchema);
