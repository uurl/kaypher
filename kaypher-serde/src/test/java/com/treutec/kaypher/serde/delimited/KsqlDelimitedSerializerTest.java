...
public class KaypherDelimitedSerializerTest {
  ...
  private KaypherDelimitedSerializer serializer;

  @Before
  public void setUp() {
    serializer = new KaypherDelimitedSerializer(CSVFormat.DEFAULT.withDelimiter(','));
  }
  ...
  private void shouldSerializeRowCorrectlyWithNonDefaultDelimeter(final char delimiter) {
    ...
    final KaypherDelimitedSerializer serializer =
        new KaypherDelimitedSerializer(CSVFormat.DEFAULT.withDelimiter(delimiter));
