...
public class KaypherAvroDeserializerTest {
  ...
  private static final KaypherConfig KAYPHER_CONFIG = new KaypherConfig(Collections.singletonMap(
      KaypherConfig.SCHEMA_REGISTRY_URL_PROPERTY, "fake-schema-registry-url"));
  ...
  private void givenDeserializerForSchema(final Schema schema) {
    final KaypherAvroSerdeFactory serdeFactory = new KaypherAvroSerdeFactory(
        KaypherConstants.DEFAULT_AVRO_SCHEMA_FULL_NAME);
