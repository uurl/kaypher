...
public class KaypherJsonSerializerTest {
  ...
  private KaypherJsonSerializer serializer;
  ...
  public void shouldThrowOnMapSchemaWithNonStringKeys() {
    ...
    // When:
    new KaypherJsonSerializer(physicalSchema);
  }
  ...
  private void givenSerializerForSchema(final Schema serializedSchema) {
    ...
    serializer = new KaypherJsonSerializer(persistenceSchema);
  }
}
