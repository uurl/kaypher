...
public class KaypherJsonDeserializerTest {
  ...
  private KaypherJsonDeserializer deserializer;
  ...
  public void shouldThrowOnMapSchemaWithNonStringKeys() {
    ...
    // When:
    new KaypherJsonDeserializer(physicalSchema);
  }
  ...
  private void givenDeserializerForSchema(final Schema serializedSchema) {
    ...
    deserializer = new KaypherJsonDeserializer(persistenceSchema);
  }
